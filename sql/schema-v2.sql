...
CREATE TABLE IF NOT EXISTS src_address (
  ...
  KEY src_address_idx (address_player_id, address_netip)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS src_keyhash (
  ...
  KEY src_keyhash_idx (keyhash_player_id, keyhash_hash)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS src_player (
  ...
  FULLTEXT KEY src_player_idx (player_name)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS serenity_server (
  ...
  server_gameport SMALLINT UNSIGNED NULL,
  ...
  server_hostname VARCHAR(32) NOT NULL DEFAULT '',
  server_gametype VARCHAR(32) NOT NULL DEFAULT '',
  server_gameid VARCHAR(32) NOT NULL DEFAULT '',
  server_mapname VARCHAR(32) NOT NULL DEFAULT '',
  server_numplayers SMALLINT UNSIGNED NOT NULL DEFAULT 0,
  server_maxplayers SMALLINT UNSIGNED NOT NULL DEFAULT 0,
  server_version VARCHAR(12) NULL,
  server_bytesreceived BIGINT UNSIGNED NOT NULL DEFAULT 0,
  server_bytessent BIGINT UNSIGNED NOT NULL DEFAULT 0,
  server_updatesuccess INT UNSIGNED NOT NULL DEFAULT 0,
  server_updatefail INT UNSIGNED NOT NULL DEFAULT 0,
